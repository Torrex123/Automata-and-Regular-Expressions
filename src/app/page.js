  ...
  return (
    <div className={styles.page}>
      <div className={styles.header}>
        <h1> Expresiones Regulares y Autómatas </h1>
      </div>
      <div className={styles.content}>
        ...
        <div className={styles.data}>
          ...
          <div className={styles.flex}>
            {showTable && <div className={styles.transitionTable}><TransitionTable /></div>}
            <div className={styles.column}>
              {showTable && <div className={styles.additionalInfo}><AdditionalInfo /></div>}
              {showTable && <div className={styles.additionalInfo}><Simulation /></div>}
              {showTable && <div className={styles.additionalInfo}><Recognition /></div>}
            </div>
          </div>
        </div>
        <Automata nfaTable={nfaTable} />
      </div>
    </div>
  );
}
